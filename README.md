...
- [x] [Развернутый проект на GitHub Pages - Гостевая страница](https://nikolay87-ru.github.io/shfe-diplom/ 'Ссылка на проект')<br>
- [x] [Развернутый проект на GitHub Pages - Страница администратора](https://nikolay87-ru.github.io/shfe-diplom/admin 'Ссылка на проект')
...
_PS. Если валидация запускается с ошибками, попробуйте запустить fix для линтинга_:
